...
<div class="row justify-content-center">
        ...
        <div class="col-lg-8 col-md-10 col-sm-12">
          <div class="row align-self-center mb-2">
            ...
            <form id="form-filter">
                ...
                <input type="hidden" name="sortInfo" value="hit"/>
            
                  <select
                    id="sort-area"
                    class="form-select ms-5 me-1 w-50"
                    aria-label="Default select example"
                    name="sort-select"
                      onchange="sortByHit(this.value)"        
                  >
    ...
    <script>
     ...
     function sortByHit(value) {
         //fetch("${root}/board?action=list&sortInfo="+value);
        let form = document.querySelector("#form-filter");
        form.setAttribute("action", "${root}/board/list&sortInfo=" + value);
        form.submit();
    };
