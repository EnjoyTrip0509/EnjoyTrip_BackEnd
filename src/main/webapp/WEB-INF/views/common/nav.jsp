<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <head>
    ...
    <link rel="stylesheet" href="${root}/resources/static/css/search-style.css">
        ...
        <div class="container px-5">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item"><a class="nav-link" href="${root}/attraction/init">지역별관광지</a></li>
              <li class="nav-item"><a class="nav-link" href="${root}/announce/list?pgno=1&key=&word=">공지사항</a></li>
              <li class="nav-item"><a class="nav-link" href="${root}/board/list?pgno=1&key=&word=">자유게시판</a></li>
              <c:if test="${not empty loginUser}">
              <li class="nav-item"><a class="nav-link" href="${root}/mytrip/">나의여행계획</a></li>
              <li class="nav-item"><a class="nav-link" href="hotplace.html">핫플자랑하기</a></li>
              <li class="nav-item"><a class="nav-link" href="${root}/announce?action=list">여행정보공유</a></li>
              ...
              <li class="nav-item"><a class="nav-link" data-bs-toggle="modal" data-bs-target="#findPasswordModal">비밀번호 찾기</a></li>              
              ...
              <li class="nav-item dropdown">
                ...
                <li><a class="dropdown-item" href="${root}/user?action=showUsersInfo">전체회원정보보기</a></li>
                </ul>
              </li>
              </c:if>
              <!--
