          ...
          <table class="table table-hover">
            ...
            <tbody>    
				<c:forEach var="announcement" items="${announcements}">    
	              <tr class="text-center">
	                <th scope="row">${announcement.articleNo}</th>
	                <td class="text-start">
	                  <a
	                    href="#"
	                    class="article-title link-dark"
	                    data-no="${announcement.articleNo}"
	                ...
	                <td>${announcement.registerTime}</td>
	              </tr>            
				</c:forEach>   
            </tbody>
          </table>
    ...
    <script>
      ...
      titles.forEach(function (title) {
        title.addEventListener("click", function () {
          ...
          location.href = "${root}/announce/view?articleno=" + this.getAttribute("data-no");
        });
      });
      ...
      document.querySelector("#btn-search").addEventListener("click", function () {
          ...
          form.setAttribute("action", "${root}/announce");
          form.submit();
      });
