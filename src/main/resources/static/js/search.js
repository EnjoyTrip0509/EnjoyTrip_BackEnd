const serviceKey =
  "9e5KQGdk0ZzKQTGXMuhZCRWzuEVjMtNLD0qciRH61NAkE1cUPpSwz%2Bbjt6gLQtnaK04ODat4knh%2F1DX5OSBUCA%3D%3D";
    ...
    const iwContent = `<div class="title">
            ...
            <div class="body">
              ...
              <img src="${positions[i].firstimage}" width="73" height="70">
                ...
                <button data-contentId = ${positions[i].contentId} onclick="add(this.dataset)">내 여행 계획에 추가</button>
            </div>`;
...
function fetchGuGunOption(areaCode) {
  const gugunUrl = `https://apis.data.go.kr/B551011/KorService1/areaCode1?serviceKey=${serviceKey}&numOfRows=20&pageNo=1&MobileOS=ETC&MobileApp=AppTest&_type=json&areaCode=${areaCode}`;
...
//
  ...
  document.getElementById("search-area").addEventListener("change", function (e) {
    fetchGuGunOption(this.value);
  });
